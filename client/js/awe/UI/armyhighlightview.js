...
AWE.UI = (function(module) {
  ...
  module.createArmyHighlightView = function(spec, my) {
    ...
    that.initWithControllerAndArmy = function(controller, army, frame) {
      ...
      if (_army.getBattle_id() || _army.getTarget_location_id()) {
        var lines = 3;
      }
      else {
        var lines = 1;
      ...
      _infoText1View.setText(army.getStrength());
      ...
      if (lines > 1) {
        ...
        _infoText2View.setText(army.getStrength());
        ...
        _infoText3View.setText(army.getStrength());
        _container.addChild(_infoText3View.displayObject());
      }
      
      var _actionPointsText = new Text(army.getAp_present() + " / " + army.getAp_max(), "10px Arial", "#000");
