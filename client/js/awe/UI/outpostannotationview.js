...
AWE.UI = (function(module) {
  ...
  module.createOutpostAnnotationView = function(spec, my) {
    ...
    that.recalcView = function() {
      ...
      if (enterButton) {
        enterButton.setVisible(my.outpostView.selected());
      }
      ...
      if (attackButton) {
        attackButton.setVisible(my.outpostView.selected());
      }
      ...
      if (spyButton) {
        spyButton.setVisible(my.outpostView.selected());
      }
      ...
      if (battleButton) {
        battleButton.setVisible(my.outpostView.selected());
      }    
