...
AWE.UI = (function(module) {
  ...
  module.createMaincontrolsView = function(_windowSize, _layer, _controller) {
    ...
    _view.redraw = function() {
      ...
      container.addChildAt(_messagesButtonText);
      container.addChildAt(_messagesButton);
      container.addChildAt(_moreButtonText);
      container.addChildAt(_moreButton);
      container.addChildAt(_locationsButtonText);
      container.addChildAt(_locationsButton);
      container.addChildAt(_armiesButtonText);
      container.addChildAt(_armiesButton);
      container.addChildAt(_heroButtonText);
      container.addChildAt(_heroButton);
      container.addChildAt(_flagButtonText);
      container.addChildAt(_flagShape);
      container.addChildAt(_fortressButtonText);
      container.addChildAt(_fortressButton); 
      container.addChildAt(_resource1Text);
      container.addChildAt(_resource2Text);
      container.addChildAt(_resource3Text);
      container.addChildAt(_resource4Text);
      container.addChildAt(_resource5Text);
      container.addChildAt(_resource6Text);
      container.addChildAt(_resourcesShape);
      container.addChildAt(_shopButtonText);      
      container.addChildAt(_shopShape);
