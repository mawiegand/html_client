...
//  "map/tiles/plain512":     AWE.Config.RAILS_ASSET_PATH + 'tiles/plain512.png',
    ...
    "map/artifact/1":         AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_1.png',
    "map/artifact/2":         AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_2.png',
    "map/artifact/3":         AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_3.png',
    "map/artifact/4":         AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_4.png',
    "map/artifact/5":         AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_5.png',
    "map/artifact/6":         AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_6.png',
    "map/artifact/7":         AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_7.png',
    "map/artifact/8":         AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_8.png',

    "map/artifactinitiated/0": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_0.png',
    "map/artifactinitiated/1": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_1.png',
    "map/artifactinitiated/2": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_2.png',
    "map/artifactinitiated/3": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_3.png',
    "map/artifactinitiated/4": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_4.png',
    "map/artifactinitiated/5": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_5.png',
    "map/artifactinitiated/6": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_6.png',
    "map/artifactinitiated/7": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_7.png',
    "map/artifactinitiated/8": AWE.Config.RAILS_ASSET_PATH + 'artifact/artifact_ini_8.png',
