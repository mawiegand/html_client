  ...
  module.createRightHUDControlsView = function(spec, my) {
    ...
    that.recalcView = function() {
      ...
      if (!_questsButton) {
        ...
        _questsButton.setFrame(AWE.Geometry.createRect(0, 82*AWE.Settings.hudScale, 52*AWE.Settings.hudScale, 52*AWE.Settings.hudScale));
      ...
      if (AWE.GS.TutorialStateManager.getTutorialState()) {
        ...
        if (allQuestStates !== undefined && allQuestStates > 0) {
          if (!_questsCountButton) {
            ...
            _questsCountButton.setFrame(AWE.Geometry.createRect(37*AWE.Settings.hudScale, 92*AWE.Settings.hudScale, 34*AWE.Settings.hudScale, 32*AWE.Settings.hudScale));
