...
AWE.Action.Fundamental = (function(module) {
  ...
  module.createChangeCharacterSameIPAction = function(newSameIP, my) {
    ...
    that.getURL = function() { return AWE.Config.ACTION_SERVER_BASE+'fundamental/change_character_same_ip_actions'; }
